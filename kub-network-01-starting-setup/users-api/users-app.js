...
app.post('/signup', async (req, res) => {
  ...
  try {
    // AUTH_SERVICE is generated by kubernetes as an env variable, is the name of the service (auth-service) all caps and with dashes replaced by underscores. So the ip address is automatically assigned.
